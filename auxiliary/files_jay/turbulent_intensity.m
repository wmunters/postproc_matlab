function sigma = turbulent_intensity(u,v,Nx,Ny,Nz,zcc,z_h,dx,dy)
...
figure
 ...
 xlabel('$\it{\sigma/u_{*}}$','FontSize',15,'FontName','Times',...
       'Interpreter','latex');
 ylabel('$\it{z/z_{h}}$','FontSize',15,'FontName','Times','Interpreter','latex');


   set(gca,'XTick',0:1:2,'FontSize',12,'FontName','Times')
